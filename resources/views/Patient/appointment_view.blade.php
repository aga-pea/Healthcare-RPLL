            ...
            <div class="form-panel">
              <form action="/patient_appointment_pick" class="form-horizontal style-form">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3">Department yang tersedia</label>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="hidden-phone">{{$data["appt_date"]}}</td>
                    <td>{{$data["appt_time"]}} </td>
                    <td><span class="label label-info label-mini">{{$data["appt_status"]}}</span></td>
                    <td>{{$data["appt_reason"]}}</td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
