  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Pilih Patient</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              
              <form class="form-horizontal style-form" action="/doctor_medical_data_list_record" method="get">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>">
                <h4 class="mb"><i class="fa fa-angle-right"></i>Pilih Patient yang ingin dibuat Medical Datanya</h4>
                  <select class="form-control" name="patient">
                      @foreach($list_patient_nameid as $data)
