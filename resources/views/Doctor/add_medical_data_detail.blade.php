              ...
              <form class="form-horizontal style-form" action="/doctor_medical_data_detail_medicine" method="get">
                <h4 class="mb"><i class="fa fa-angle-right"></i>Medical Record</h4>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="anamnesia">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Disease</label>
                    <div class="col-sm-10">
                      <select class="form-control" name="disease">
                          @foreach($disease_list as $data)
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Hospital Reference</label>
                    <div class="col-sm-10">
                      <select class="form-control" name="hospital">
                          @foreach($hospital_list as $data)
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Visit Cost</label>
                    <div class="col-sm-10">
                      <select class="form-control" name="cost">
                          @foreach($cost_list as $data)
                          <option value={{$data->cost_id}}>{{$data->treatment}} (Rp.{{$data->price}},00)</option>
                          @endforeach
                      </select>
                    </div>
                  </div>
                <button type="submit" name="submit" value="add" class="btn btn-theme">Submit</button>
              </form>
              <br>
              @if (count($errors) > 0)
