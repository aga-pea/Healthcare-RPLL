          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <thead>
                  <tr>
                    <th class="hidden-phone">Record Id</th>
                    <th><i class="fa fa-clock-o"></i>Anamnesia</th>
                    <th>Record Date</th>
                    <th><i class=" fa fa-edit"></i>Edit</th>
                  </tr>
                </thead>
                <tbody>
                  @foreach($med_record_data as $data)
                  <tr>
                    <form action="/doctor_medical_data_detail_view_update" method="get">
                      @csrf
