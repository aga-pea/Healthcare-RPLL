  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Input New Patient</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">    
            <form class="form-horizontal style-form" action="/receiptionist_patient_register_proses" method="get">
                <h4 class="mb"><i class="fa fa-angle-right"></i>Patient</h4>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3 col-xs-11">
                      <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="01-01-2014" class="input-append date dpYears">
                        <input type="text" readonly="" value="2020-04-07" size="16" class="form-control" name="patient_dob">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Gender(L/P)</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="patient_uname">
                    </div>
                  </div>
                  <div class="form-group">
