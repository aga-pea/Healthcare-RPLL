  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Pilih Patient yang ingin mendaftar</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  @foreach($patientAll as $data)
                  <tr>
                    <form action="/receiptionist_new_appointment" method="get">
                    @csrf
                    <input type='hidden' name='id' value='{{$data->patient_id}}'>
                    <td>{{$data->patient_name}}</td>
                    <td class="hidden-phone">{{$data->patient_address}}</td>
                    <td>{{$data->patient_dob}}</td>
