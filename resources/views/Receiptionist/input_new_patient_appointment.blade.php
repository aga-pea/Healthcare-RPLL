  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Department yang tersedia tanggal {{$tgl}}</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              
              <form class="form-horizontal style-form" action='/receiptionist_new_patient_appointment_proses' method="get">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>">
                <input type = "hidden" name = "tgl" value = {{$tgl_format}}>
                <h4 class="mb"><i class="fa fa-angle-right"></i>Pilih tipe department yang diinginkan</h4>
