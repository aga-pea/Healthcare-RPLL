...
insert into 
	patient(patient_name, patient_address, patient_age, patient_dob, patient_gender, patient_uname, patient_pwd) 
	values('Fikri', 'Taman Rahayu', 20, '1999-04-20', 'L', 'fikri01', 'fikri123');

insert into 
	patient(patient_name, patient_address, patient_age, patient_dob, patient_gender, patient_uname, patient_pwd) 
	values('Gwen', 'Taman Kopo', 18, '2001-06-10', 'P', 'gwen10', 'gwen123');
